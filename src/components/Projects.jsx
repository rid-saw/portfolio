...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: 'Flash-Cards-4-Fun',
      description: 'Full-stack notes-to-flashcards web app. FastAPI backend ingests markdown/text notes, prompts an LLM to generate grounded Q/A pairs, and serves decks to a React + Vite frontend with a study UI.',
      tech: ['Python', 'FastAPI', 'React', 'Vite', 'Gemini', 'Anthropic', 'OpenAI'],
      highlights: [
        'Provider-agnostic generation layer with swappable Gemini, Anthropic, and OpenAI backends behind a single interface',
        'Same logic powers a CLI entrypoint for terminal-based deck generation',
        "Shipped a zero-backend Claude Artifact version and published it to Anthropic's public artifact marketplace",
      ],
      gradient: 'from-cyan-500 to-blue-500',
      github: 'https://github.com/rid-saw/flash-cards-4-fun',
    },
    {
